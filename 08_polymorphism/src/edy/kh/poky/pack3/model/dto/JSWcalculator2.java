...
// 각자 구현한 계산기
public class JSWcalculator2 implements Calculator, Machine{
	...
	public boolean rangeCheck(int num) {
		// if(num >= Calculator.MIN_NUM && num <= Calculator.MAX_NUM) return true;
		// return false;
...
//		return num;
	...
	@Override
	public void powerOn() {
		System.out.println("정승우2222 계산기 실행");
	}

	@Override
	public void powerOff() {
		System.out.println("정승우2222 계산기 종료");
	}
