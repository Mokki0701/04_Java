...
public class PrintEx1 {
	public static void main(String[] args) {
		 ...
		 *  -- 패턴 종류
		 *  
		 *  %d : 십진법 정수 (byte, short, int)
		 *  %c : 문자 (char)
		 *  %s : 문자열 (String)
		 *  %b : 논리형 (boolean)
		 *  %f : 실수형 (float/double)s
		 *  
		 * 
		 * 양수 : 오른쪽 정렬
		 * 음수(-) : 왼쪽 정렬
		...
		System.out.printf("%s은 %d세 %c성으로 키는 %.1f이고, 자바 공부 여부 : %b",
		...
		System.out.printf("%8s %-6s %7d원 %s \n",
				"20240126", dan2, num2, "출금");		
		System.out.printf("%8s %-6s %7d원 %s \n",
				"20240125", dan3, num3, "출금");
