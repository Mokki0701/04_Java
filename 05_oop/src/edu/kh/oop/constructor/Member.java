package edu.kh.oop.constructor;import javax.sound.midi.SysexMessage;
...
public class Member {
	...
	/* 기본 생성자 */
	// - 매개 변숙 ㅏ없는 형태
	// - 생성자가 하나도 작성되 않은 경우 컴파일러가 자동으로 추가
	public Member() {
	...
	/* 매개 변수 생성자 */
	// - 객체 생성 시 매개 변수로 절달된 값을
	//   생성된 객체의 필드에 초기화하는 요도의 생성자
  ...
  //	public Member(int memberAge, String memberPw) {}
	//  오버로딩 : 메서드에서 이름이 같아도 매개변수의 타입, 수, 순서에 따라서 같은 이름을 쓸 수있는것
	...
	// setter : 전달 받은 매개 변수로 현재 객체의 필드를 초기화
