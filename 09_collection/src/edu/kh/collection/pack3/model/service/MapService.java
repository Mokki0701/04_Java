...
public class MapService {
	 ...
	 * 			 해당되는 상세한 값(Value)를 얻을 수 있는 컬렉션 개체
	 * 
	 * - K:V 형식으로 구성
	 * 
	 * - K:V 한 쌍을 Entry라고 부름
	 ...
	 *  -> Key 역할의 객체는 hashCode(), eqauls() 오버라이딩 필수
	 *  
	...
	public void method1() {
		...
		System.out.println(map.put(1, "스팸볶음밥"));
		System.out.println(map.put(2, "허쉬브라운빙수"));
		System.out.println(map.put(3, "황금올리브블랙페퍼"));
		...
		System.out.println("--------------------------------------------------");
		System.out.println(map.get(1)); // 스팸볶음밥
	...
	// getKey() : HashMap의 특정 값에 대응하는 키를 반환하는 메서드
	// 키-값 쌍으로 데이터 저장 -> 주어진 값에 대응하는 키를 찾아 반환
	
	// replace() : HashMap에서 특정 키에 대응하는 값을 변경하는 메서드
	// 주어진 키에 대응하는 값이 존재하는 경우, 새로운 값을 해당 키에 대입하여 기존 값을 대체
