...
public class SetService {
	...
	/*
	 * HashSet 사용법!
	 * - 사용조건 1 : 객체에 equals()   오버라이딩 되어 있어야함
	 * - 사용조건 2 : 객체에 hashCode() 오버라이딩 되어 있어야함
	 * 
	 * -> String, Integer 등 자바에서 제겅하는 객체는
	 *   모두 오버라이딩 되어있는 상태!!
	 */
	public void method1() {
...
//	Set<String> set = new LinkedHashSet<String>(); // 다형성-업캐스팅
		...
		// 전달 받은 e가 Set에 있으면 true, 없으면 falses
	...
	public void method3() {
		...
		// A.equals(B) : A와 B가 가지고 있는 필드 값이 같다면 true 다르면 false
	...
	public void lottoNumberGenerator() {
		...
		for(int i = 0; i < (money/1000); i++) {
			...
			lottoList.add(new TreeSet<Integer>(lotto)); // List에 Set 추가(담기)
