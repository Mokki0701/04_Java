...
public class JavaAPIService {
	...
	public void method1() {
		...
		list.add(1000); // (int) 1000 -> (Integer) 1000
		list.add(2000);
		list.add(3000); 
		String str = "123";
		...
		System.out.println(list.get(0) + list.get(1)+ list.get(2) + Integer.parseInt(str));
	}
	 ...
	 * - 동일한 리터럴을 이용해 String 객체를 생선하 ㄴ경우
	 * 	 추가적으로 객체를 생성하지 않고
	...
	public void method4() {
		...
		// 같음을 비교
		System.out.println("저장된 값 비교 : " + temp1.equals(temp2)); // 객체의 필드 값을 비교
		System.out.println("주소를 비교 : " + (temp1 == temp2)); // 변수에 저장된 값(주소) 비교
