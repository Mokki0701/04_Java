package edu.kh.todoList.model.view;
...
public class TodoListView {
	...
	private void todoDetailView() throws NumberFormatException, IOException {
		...
		System.out.print("꺼내올 번호를 입력 하세요 : ");

		int input = Integer.parseInt(br.readLine());
		// Parsing : String 데이터를 원하는 자료형으로 변경
			
		// 할 일 상세 조회 서비스 호출 후 결과 반환 받기
		String todoDetail = service.todoDetailView(input);
	...
	private void todoAdd() throws IOException {
		...
		System.out.println("상세 내용 입력 (입력 종료 시 !wq 작성 후 엔터) : ");
		System.out.println("-----------------------------------------------");
	...
	private void todoUpdate() throws NumberFormatException, IOException {
		...
		System.out.println("수정 할 내용 입력 (입력 종료 시 !wq 작성 후 엔터) : ");
		System.out.println("-----------------------------------------------");
