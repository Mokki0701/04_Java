...
public class ArrayEx1 {
	...
	public void method2() {
		...
		// 해당 구문 수행 전 break point를 작성해서 멈추개함
	...
	public void method3() {
		...
		for(int i =3; i >= 0; i--) {
			System.out.printf("subjects[%d[ : %s", i, subjects[i]);
		}
	}
	...
	public void method4() {
		...
		System.out.println(nums); // 주소(비스무리한 것)
		
		System.out.println(Arrays.toString(nums)); // 배열 요소 출력
	}
